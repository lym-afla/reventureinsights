...
const CounterSection = ({ sectorCount = 40, companyCount = 200 }: CounterProps) => {
  ...
  const animateCount = (element: HTMLElement, start: number, end: number, duration: number) => {
    let current = start
          ...
          <div className="f-feature-card-large">
            <div className="f-margin-bottom-130">
              <div className="f-feature-icon-wrapper white-background">
                <Image src="/images/house.png" width={512} height={512} alt="House icon representing real estate" />
              </div>
            </div>
            <div className="f-margin-bottom-130">
              <div className="f-margin-bottom-04">
                <h5 id="sectorCount" ref={sectorCountRef} className="f-h1-heading-4">
                  0
                </h5>
              </div>
              <div className="f-heading-detail-small database-feature">Sector count</div>
            </div>
          </div>
          <div className="f-feature-card-large">
            <div className="f-margin-bottom-130">
            ...
            <div className="f-margin-bottom-130">
              <div className="f-margin-bottom-04">
                <h5 className="f-h1-heading-4">
                  &gt;
                  <span id="startupCount" ref={startupCountRef}>
                    0
                  </span>
                </h5>
              </div>
              <div className="f-heading-detail-small database-feature">Company count</div>
            </div>
          </div>
        </div>
      </div>
